 ...
 <TABLE cellSpacing=0 borderColorDark=#ffffff cellPadding=0 
            width="100%" borderColorLight=#cccccc border=1>
              ...
              <TR align=middle bgColor=#dbdbdb>
				...
				<%
					SQL_m = "Select image1,cate From banner Where category_top = 1 Order By num Asc"
					RS.Open SQL_m, DB, 1
					IF Not RS.EOF Then
              ...
              <TR>
				...
				<%
					...
					Else
					Response.Write "<TR><TD width=134 height=50>오늘의 Top_Event 상품은 없습니다.</TD></TR>"
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR>
                <TD height=4></TD></TR></TBODY></TABLE><!-- 기획전 관리 끝 -->
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR>
