...
//-->
		...
		<div id="Notice" style="position:absolute; left:5; top:5; width:200; z-index:5; filter:revealTrans(transition=23,duration=0.5) blendTrans(duration=0.5); border-width:1px; border-style:none;" onmouseover="dragObj=Notice; drag=1;move=0" onmouseout="drag=0">
			<table border="0" cellpadding="2" cellspacing="0" width="400" bgcolor="#94AAD6">
				<tr>
					<td>
				...
				<tr>
					<td style="padding:10" height="150">
						<Font color="#000000" size="4">
						<pre><B>KISEC 모의해킹 WebSite입니다.
이 쇼핑몰은 실제로 운영되는 사이트가 아닌 

실습 목적에 의한 DEMO 사이트 입니다.

그래서 상품을 주문하셔도 물품이 배송되지 않습니다.

^^관리자모드를 보시려면 본 사이트의 우측 상단에 위치한

<font color="red">RedZone</font>을 클릭하시면 
...
사이트의 디자인을  참조하였습니다. ^^
	...
	<font color="red">BY KISEC</Font></pre>
					</td>
					</td>
				</tr>
				<tr>
