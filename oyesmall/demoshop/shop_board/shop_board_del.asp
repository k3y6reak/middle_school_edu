...
<BR><BR><BR><BR><BR><BR><BR><BR><BR><BR>
	...
	비밀번호를 입력해 주세요..
      <TABLE width=250 border=0  cellSpacing=1 cellPadding=3 >
        <FORM name=delete action="./shop_board_del_ok.asp" method=post>
			...
			<TR height=50 bgcolor="#ffffff" >
				  <TD align=middle background="../shop_image/com_image.jpg"><BR><INPUT class=input type=password maxLength=20 name=pwd> <BR><BR><INPUT class=kissofgod-submit type=submit value=Delete>　 
